...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('msfabrics_core_path', null,
                    $modx->getOption('core_path') . 'components/msfabrics/') . 'model/';
            $modx->addPackage('msfabrics', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/msfabrics/model/schema/msfabrics.mysql.schema.xml';
